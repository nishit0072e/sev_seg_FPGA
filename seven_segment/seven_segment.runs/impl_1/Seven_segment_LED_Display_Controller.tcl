...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/test/seven_segment/seven_segment.cache/wt [current_project]
  set_property parent.project_path D:/test/seven_segment/seven_segment.xpr [current_project]
  set_property ip_repo_paths d:/test/seven_segment/seven_segment.cache/ip [current_project]
  set_property ip_output_repo d:/test/seven_segment/seven_segment.cache/ip [current_project]
  add_files -quiet D:/test/seven_segment/seven_segment.runs/synth_1/Seven_segment_LED_Display_Controller.dcp
  read_xdc D:/test/seven_segment/seven_segment.srcs/constrs_1/new/bndfh.xdc
